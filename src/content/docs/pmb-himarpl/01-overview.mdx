...
[pmb.himarpl.org](https://pmb.himarpl.org) is the official website by HIMARPL (Himpunan Mahasiswa Rekayasa Perangkat Lunak) for providing information about new student admissions at UPI's Software Engineering program. The website is built using Next.js and follows the T3 Stack architecture.
