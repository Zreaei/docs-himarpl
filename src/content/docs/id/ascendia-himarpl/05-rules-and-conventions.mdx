...
description: Mempelajari tentang aturan dan ketentuan yang digunakan dalam proyek situs web Kabinet Ascendia HIMARPL.
---
...
Jika Anda belum familiar dengan TypeScript, Anda bisa memeriksa artikel ini untuk mempelajari lebih lanjut : [Typescript untuk React _Developer_](https://elazizi.com/posts/how-to-learn-typescript-for-react-developers/)
