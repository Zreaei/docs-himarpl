...
description: Struktur Folder Situs Web Kabinet Ascendia HIMARPL
---
...
- **hooks/**: _Custom_ React Hooks untuk logika _state management_ global
- **lib/**: Utilitas inti dan logika logika _state management_ global
  - Pembantu otentikasi
  - Utilitas umum
