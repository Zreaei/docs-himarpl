...
[ascendia.himarpl.org](https://ascendia.himarpl.org) adalah situs web resmi untuk Kabinet Ascendia pada Himpunan Mahasiswa Rekayasa Perangkat Lunak (HIMARPL) di Universitas Pendidikan Indonesia. Situs web ini dibangun menggunakan Next.js dengan T3 Stack dan di-_deploy_ di Vercel.
