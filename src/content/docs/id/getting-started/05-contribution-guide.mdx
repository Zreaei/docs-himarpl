...
di setiap repositori yang akan Anda kontribusikan, tepatnya pada bagian [proyek _open-source_](/id/getting-started/04-opensource-projects).

## Panduan Commit

- Ikuti panduan _Conventional Commits_
