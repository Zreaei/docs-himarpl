...
3. **Konfigurasi _Rate Limitting_ Upstash**
   - Ikuti [Panduan _Rate Limitting_ Upstash](https://upstash.com/docs/oss/sdks/ts/ratelimit/gettingstarted) untuk mendapatkan:
...
7. Setelah Anda puas dengan perubahannya, add dan commit perubahan tersebut pada branch Anda, kemudian push branch Anda ke repositori fork.
   ...
   :::note[PENTING]
    Sebelum melakukan commit dan membuka Pull Request, tolong baca [Panduan Commit](/id/getting-started/05-contribution-guide/#commit-guidelines) dan [Kebijakan Pull Request](/id/getting-started/05-contribution-guide/#pull-request-policy) berikut.
   :::

8. Buat Pull Request.
   :::note[CATATAN]
    Kami mengimbau kepada pembuat PR untuk menghindari _rebasing_/memperbarui PR Anda dengan `main` branch secara tidak perlu.
   :::
</Steps>
