...
[blog.himarpl.com](https://blog.himarpl.com) adalah platform blog resmi untuk anggota HIMARPL (Himpunan Mahasiswa Rekayasa Perangkat Lunak). Website ini dibangun menggunakan Next.js dengan T3 Stack dan dilengkapi dengan rich text editor yang didukung oleh TipTap.
