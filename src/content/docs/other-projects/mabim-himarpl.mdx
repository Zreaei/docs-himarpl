...
[mabim.himarpl.org](https://mabim.himarpl.org) is the first one and only website by HIMARPL for providing information about Masa Bimbinagan RPL (Student Orientation Program) at UPI. The website is built using NextJS.
